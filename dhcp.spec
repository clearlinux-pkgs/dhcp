...
Source0  : https://downloads.isc.org/isc/dhcp/4.4.3/dhcp-4.4.3.tar.gz
Source1  : dhcp.tmpfiles
Source2  : dhcp4.service
Source3  : https://downloads.isc.org/isc/dhcp/4.4.3/dhcp-4.4.3.tar.gz.asc
...
%prep
%setup -q -n dhcp-4.4.3
cd %{_builddir}/dhcp-4.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646870081
...
cp %{_builddir}/dhcp-4.4.3/LICENSE %{buildroot}/usr/share/package-licenses/dhcp/63d12e221cdfb67f6aa4a9216494896cab0d356a
%make_install
